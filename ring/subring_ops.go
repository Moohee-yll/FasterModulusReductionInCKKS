...
func (s *SubRing) SubThenMulScalarMontgomeryTwoModulusAlongMatrix(
	p1 []uint64, p2 [][]uint64, scalarMonts, moduli, sMRedConstants []uint64) {

	subthenmulscalarmontgomeryTwoModulusvecAlongMatrix(
		p1, p2, scalarMonts, moduli, sMRedConstants)
}
